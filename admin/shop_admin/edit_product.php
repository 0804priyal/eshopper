                  ...
                  <div class="box-body">                     
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-select" name="size" value="<?php echo $data['size']?>" aria-label="Default select example">
                            ...
                            ?>
                            <option <?php if($sizematch == $value) { echo "selected"; }?> value="<?php echo $value;?>"><?php echo $value;?></option>                            
                            <?php              
                            }
                            ?>
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-select" name="color" value="<?php echo $data['color']?>" aria-label="Default select example">
                            <?php 
                              $color = array('Black', 'White', 'Green', 'Yellow', 'Blue', 'Red');
                              $colormatch = $data['color'];
                              foreach ($color as $value) {
                              ?>
                              <option <?php if($colormatch == $value) {?>selected <?php }?>value="<?php echo $value; ?>"><?php echo $value; ?></option>
                              <?php 
                                }
                              ?>                           
                          </select>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="fulldescription" name="fulldescription" rows="8"><?php echo $data['fulldescription']?></textarea>
                      </div>

                      <div class="form-group">
                        <label>Information</label>
                        <textarea class="form-control" id="information" name="information" rows="8"><?php echo $data['information']?></textarea>
                      </div>
