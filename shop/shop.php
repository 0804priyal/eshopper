...
?>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <?php
            ...
            if(isset($_GET['id'])) {
            $cat_id=$_GET['id'];
            $sql2 = "SELECT * from dresses WHERE dress_id='".$cat_id."'";
            $result2 = $conn->query($sql2);
            $row=$result2->fetch_assoc();
            $dresscatname = $row['dresscatname'];            
        ?>
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3"><?php echo $dresscatname; ?></h1>
        ...
        ?>
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">ALL SHOP</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="index.php">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Shop</p>
