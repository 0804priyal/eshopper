    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        ...
                        ?>                        
                            <div class="carousel-item prdouct-img <?php if($i==0) { echo "active"; }?>">
                                <img class="w-100 h-100" src="../admin/bannerimg/<?php echo $productimg; ?>" alt="Image">
                            </div>
                        <?php
                            $i=$i+1;
                            }
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">$<?php echo $offerprice; ?>.00</h3>
